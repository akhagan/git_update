...
Because you're physically holding the camera, you get to choose what makes sense to track & what doesn't. But git doesn't know that on it's own. You have to specifically tell git what you DO NOT want snapshots of.
